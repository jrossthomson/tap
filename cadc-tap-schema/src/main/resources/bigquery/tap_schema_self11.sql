...
( 'tap_schema', 'tap_schema.schemas11', 'table', 'description of schemas in this tableset', NULL, 1),
( 'tap_schema', 'tap_schema.tables11', 'table', 'description of tables in this tableset', NULL, 2),
( 'tap_schema', 'tap_schema.columns11', 'table', 'description of columns in this tableset', NULL, 3),
( 'tap_schema', 'tap_schema.keys11', 'table', 'description of foreign keys in this tableset', NULL, 4),
( 'tap_schema', 'tap_schema.key_columns11', 'table', 'description of foreign key columns in this tableset', NULL, 5)
;
