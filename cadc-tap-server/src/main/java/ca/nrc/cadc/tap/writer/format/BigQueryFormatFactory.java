 ...
 *
 */
public class BigQueryFormatFactory implements FormatFactory
{
    protected Job job;
    
    public BigQueryFormatFactory() { }
    ...
    public Format<Object> getFormat(TapSelectItem item)
    {
        ...
        if (datatype.equalsIgnoreCase("double")){
            System.out.println("tt.arraysize: " + tt.arraysize);
            if (tt.arraysize != null){
                System.out.println("tt.arraysize: Array");
                return getDoubleFormat(item);
            } else {
                System.out.println("tt.arraysize: NonArray");
                return getDoubleFormat(item);
            }
